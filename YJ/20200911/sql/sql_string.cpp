...
5. SELECT ANIMAL_ID, NAME FROM ANIMAL_INS ORDER BY ANIMAL_ID;

6. SELECT ANIMAL_ID, NAME, DATETIME FROM ANIMAL_INS ORDER BY NAME ASC,DATETIME DESC;

7. SELECT NAME FROM ANIMAL_INS ORDER BY DATETIME LIMIT 1;
